  ...
  return (
    <div>
      ...
      <div className="mx-5 lg:mx-40">
        <h2 className="my-5 md:my-10 text-center text-xl md:text-4xl font-bold text-red-700 uppercase">
          {course_name}
        </h2>
        <p className="text-md md:text-2xl text-fuchsia-900">{course_desc}</p>
